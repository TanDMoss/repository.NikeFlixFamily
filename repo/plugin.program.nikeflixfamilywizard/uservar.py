...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'nikeflixfamilywizard'
BUILDERNAME = 'nikeflixfamilywizard'
EXCLUDES = [ADDON_ID, '']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/TanDMoss/repository.NikeFlixFamily/refs/heads/main/repo/plugin.program.nikeflixfamilywizard/resources/text/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]nikeflixfamilywizard[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing nikeflixfamilywizard.\n\nContact us at nikeflixfamilywizard'
...
REPOID = 'repository.NikeFlixFamily'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]nikeflixfamilywizard[/B][/COLOR]Wizard'
